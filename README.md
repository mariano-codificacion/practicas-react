# Tienda Uniformes Escolares
Este es un proyecto de ecommerce básico que se utiliza para el curso de React. La aplicación permite ver una lista de productos de una tienda de uniformes escolares y realiza compras en línea. Los productos y las órdenes de compra se almacenan en Firebase.
